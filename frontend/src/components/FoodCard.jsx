    ...
    return (
        <div className="bg-white rounded-2xl shadow-md overflow-hidden w-full max-w-sm">
            ...
            <div className="p-4 flex flex-col gap-1">
                ...
                <p className="text-sm text-neutral-500 leading-relaxed line-clamp-2 h-10">{description}</p>
                <div className="flex items-center justify-between mt-2">
                    <h4 className="text-base font-semibold text-neutral-900">₹{price}</h4>
                    <button onClick={onAdd} className="bg-green-700 hover:bg-green-800 text-white text-sm font-medium px-4 py-1.5 rounded-full cursor-pointer transition active:scale-95">Add</button>
                </div>
            </div>
        </div>
    )
